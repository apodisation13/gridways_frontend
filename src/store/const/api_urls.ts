...
export const PURCHASE_PRODUCT = `${getDomain()}/purchase-product/{productId}`
export const PURCHASE_STATUS = `${getDomain()}/purchase-status/{purchaseId}`

// upgrades
export const UPGRADES = `${getDomain()}/user-upgrades/{userId}`
