    ...
    <div class="modal" @click.stop>
      ...
      <div class="content">
        <ol>
          ...
          <!-- ВАШ СУЩЕСТВУЮЩИЙ РАЗДЕЛ 7 УДАЛИТЬ, ЗАМЕНИТЬ НА ЭТО: -->

          <li>
            <span class="uppercase"
              >Проведение оплаты через приложение (Донат)</span
            >
            <p><strong>Общие положения</strong></p>
            <ol>
              <li>
                Приложение предоставляет Пользователям возможность совершать
                добровольные пожертвования (далее — "Донат") для поддержки
                разработчиков и получения дополнительных внутриигровых
                преимуществ, указанных в Приложении.
              </li>
              <li>
                Донат осуществляется через платежные системы, интегрированные с
                Платформой (Google Play), и подлежит комиссии в соответствии с
                правилами соответствующей Платформы.
              </li>
              <li>
                Совершая Донат, Пользователь подтверждает, что действует
                добровольно, осознанно и имеет законное право распоряжаться
                используемыми денежными средствами.
              </li>
            </ol>
          </li>

          <!-- РАЗДЕЛ 8 ЗАМЕНИТЬ НА ЭТО: -->

          <li>
            <span class="uppercase">Совершение In-App покупок</span>
            <ol>
              <li>
                Внутри Приложения Пользователь может приобретать виртуальные
                товары: игровую валюту, ускорители, уникальные персонажи, скины,
                бонусы, уровни доступа и иные внутриигровые объекты (далее —
                "In-app покупка").
              </li>
              <li>
                Все In-app покупки являются окончательными и невозвратными, за
                исключением случаев, прямо предусмотренных настоящим Соглашением
                или действующим законодательством.
              </li>
              <li>
                Виртуальные товары, приобретенные в рамках In-app покупки, не
                имеют реальной денежной стоимости, не могут быть обменены на
                реальные деньги, товары или услуги, а также не могут быть
                переданы другому Пользователю.
              </li>
              <li>
                Цена In-app покупки определяется Компанией и отображается в
                Приложении в момент совершения покупки. Компания оставляет за
                собой право изменять цены в любой момент с предварительным
                уведомлением Пользователей.
              </li>
              <li>
                Совершение In-app покупки возможно только после подтверждения
                Пользователем списания средств через платежный интерфейс
                Платформы (Google Play).
              </li>
            </ol>
          </li>

          <!-- ДОБАВИТЬ НОВЫЙ РАЗДЕЛ ПОСЛЕ РАЗДЕЛА 8 (НОМЕР СМЕСТИТСЯ): -->

          <li>
            <span class="uppercase">Политика возврата средств</span>
            <p><strong>Общие правила возврата</strong></p>
            <ol>
              <li>
                В связи с цифровым характером предоставляемых Услуг и
                виртуальных товаров, возврат денежных средств за совершенные
                In-app покупки и Донаты
                <strong>не производится</strong>, за исключением случаев, прямо
                указанных в настоящем разделе.
              </li>
              <li>
                Пользователь подтверждает, что приобретение виртуального товара
                означает немедленное начало оказания Услуги, и в соответствии со
                ст. 26.1 Закона РФ "О защите прав потребителей" товар
                надлежащего качества возврату не подлежит.
              </li>

              <p><strong>Случаи, в которых возможен возврат</strong></p>
              <li>
                Компания рассматривает запросы на возврат средств только в
                следующих исключительных случаях:
                <ol>
                  <li>
                    Технический сбой, в результате которого списание средств
                    произошло, но виртуальный товар не был зачислен
                    Пользователю;
                  </li>
                  <li>
                    Случайное списание средств вследствие доказанной ошибки
                    платежной системы;
                  </li>
                  <li>Двойное списание средств за одну покупку;</li>
                  <li>
                    Иные случаи, предусмотренные правилами Google Play как
                    Платформы распространения Приложения.
                  </li>
                </ol>
              </li>

              <p><strong>Процедура подачи запроса на возврат</strong></p>
              <li>
                Для подачи запроса на возврат средств Пользователь должен:
                <ol>
                  <li>
                    Направить письмо на адрес
                    <em>twelvepeoplegame@gmail.com</em> в течение 14
                    (четырнадцати) календарных дней с момента совершения
                    покупки;
                  </li>
                  <li>
                    Указать в письме: дату покупки, сумму покупки, идентификатор
                    транзакции (номер заказа из Google Play), никнейм в игре и
                    подробное описание причины запроса;
                  </li>
                  <li>
                    Приложить скриншоты или иные доказательства, подтверждающие
                    наличие технической ошибки.
                  </li>
                </ol>
              </li>

              <p><strong>Сроки рассмотрения</strong></p>
              <li>
                Компания обязуется рассмотреть запрос Пользователя в течение 30
                (тридцати) календарных дней с момента его получения.
              </li>
              <li>
                По результатам рассмотрения Компания принимает решение о
                возврате средств или об отказе в возврате, о чем уведомляет
                Пользователя по электронной почте.
              </li>

              <p><strong>Условия отказа в возврате</strong></p>
              <li>
                Компания оставляет за собой право отказать в возврате средств в
                следующих случаях:
                <ol>
                  <li>
                    Пользователь использовал приобретенный виртуальный товар
                    (потратил игровую валюту, применил ускоритель, открыл
                    контент);
                  </li>
                  <li>Запрос подан по истечении 14 дней с момента покупки;</li>
                  <li>
                    Пользователем не предоставлены достаточные доказательства
                    наличия технической ошибки;
                  </li>
                  <li>
                    Пользователь нарушал условия Пользовательского соглашения;
                  </li>
                  <li>
                    Пользователь совершил покупку в состоянии алкогольного,
                    наркотического или иного опьянения (добросовестность
                    предполагается, пока не доказано иное).
                  </li>
                </ol>
              </li>

              <p><strong>Возврат через Google Play</strong></p>
              <li>
                Пользователь также может обратиться за возвратом средств
                непосредственно через Google Play в соответствии с правилами
                данной Платформы. Google Play может предоставить возврат в
                течение 48 часов после покупки по своему усмотрению.
              </li>
              <li>
                Компания не несет ответственности за решения, принимаемые Google
                Play в отношении возврата средств.
              </li>

              <p><strong>Блокировка аккаунта при возврате</strong></p>
              <li>
                В случае осуществления возврата средств (chargeback) через банк
                или платежную систему без предварительного согласования с
                Компанией, а также в случае необоснованного запроса на возврат,
                Компания оставляет за собой право приостановить или
                заблокировать доступ Пользователя к Приложению и удалить его
                аккаунт.
              </li>
            </ol>
          </li>
